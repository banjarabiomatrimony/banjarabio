-- Migration: Add coupons table and admin actions
-- Created: 2026-03-19
...
-- 3. Update fn_admin_actions to include coupon management
...
-- 4. public function for validating coupons
CREATE OR REPLACE FUNCTION public.fn_validate_coupon(p_code TEXT) RETURNS JSONB AS $$
...
IF v_coupon.id IS NULL THEN RETURN jsonb_build_object(
    'is_valid',
    false,
    'message',
...
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION public.fn_validate_coupon(TEXT) TO authenticated;