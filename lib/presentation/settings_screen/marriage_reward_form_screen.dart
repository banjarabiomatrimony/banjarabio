...
class _MarriageRewardFormScreenState extends State<MarriageRewardFormScreen>
    ...
    if (_isLoading) {
      return Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          title: l10n?.claimMarriageGift ?? 'Claim Marriage Gift',
        ),
  ...
  Widget _buildTierOptionCard({
    ...
    return TactilePressable(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? (isDark ? const Color(0xFF321924) : const Color(0xFFFCE4EC))
              : (isDark ? const Color(0xFF1F1F28) : theme.colorScheme.surface),
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isSelected
                ? const Color(0xFF961B33)
          ...
          boxShadow: isSelected
              ? [
                  BoxShadow(
                    color: const Color(0xFF961B33).withValues(alpha: 0.25),
                    blurRadius: 10,
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isSelected ? const Color(0xFF961B33) : theme.colorScheme.onSurface,
              ),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isSelected ? const Color(0xFF059669) : theme.colorScheme.onSurfaceVariant,
              ),
            ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.edit_calendar_rounded, size: 20, color: Color(0xFF961B33)),
          ],
        ),
      ),
    );
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: isDark
              ? [const Color(0xFF0F382A), const Color(0xFF134E39)]
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: AppTypography.labelSmall,
                    color: isDark ? Colors.white60 : const Color(0xFF047857).withValues(alpha: 0.8),
                  ),
                ),
              ],
            ),
  ...
  Widget _buildTrustGuaranteeBanner(ThemeData theme, bool isDark) {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.verified_user_rounded, color: Color(0xFFD97706), size: 22),
          SizedBox(width: 3.w),
          Expanded(
            child: Text(
  ...
  Widget _buildFaqAccordion(ThemeData theme, bool isDark) {
    return Container(
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF1E1E28) : theme.colorScheme.surface,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: theme.colorScheme.outlineVariant.withValues(alpha: 0.3),
        ),
  ...
  Widget _buildSubmitButton(ThemeData theme, AppLocalizations? l10n) {
    return TactilePressable(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [Color(0xFF880E4F), Color(0xFF961B33), Color(0xFFC2185B)],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
          borderRadius: BorderRadius.circular(16),
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF961B33).withValues(alpha: 0.4),
              blurRadius: 14,
              offset: const Offset(0, 4),
            ),
          ],
