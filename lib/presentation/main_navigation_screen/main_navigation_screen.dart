...
class MainNavigationScreenState extends ConsumerState<MainNavigationScreen> {
  ...
  Widget _getTabScreen(int index) {
    return _builtTabs.putIfAbsent(index, () {
      switch (index) {
        ...
        case 1: return const InboxScreen();
        case 2: return const BiodataScreen();
        case 3: return const ServicesScreen();
        case 4: return const AccountScreen();
  ...
  static const List<String> _tabNames = [
    'Home', 'Inbox', 'Biodata', 'Services', 'Account',
  ];

  Future<bool> _onWillPop() async {
    // 🔙 If user is on any non-Home tab (Inbox, Biodata, Services, Account), switch to Tab 0 (Home)
  ...
  Widget build(BuildContext context) {
    ...
    if (!_isReady) {
      return const Scaffold(
        backgroundColor: AppColors.canvasMidnight,
